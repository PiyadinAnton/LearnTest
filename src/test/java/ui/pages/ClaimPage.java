...
public class ClaimPage extends TestBase {
    ...
    By Select = By.xpath("//*[contains(text(), 'Select')][1]");
    By SelectVer2 = By.xpath("//div[@class='oxd-select-text oxd-select-text--active']/div[@class='oxd-select-text-input'][1]");

    By Claim = By.xpath("//*[@href='/web/index.php/claim/viewClaimModule']");

    By ExpectedEl = By.xpath("//*[contains(text(), 'Accommodation')]");

    By Remark = By.xpath("//*[@class=\"oxd-textarea oxd-textarea--active oxd-textarea--resize-vertical\"]");

    By Assign = By.xpath("//*[@class=\"orangehrm-header-container\"]//*[@class=\"oxd-button oxd-button--medium oxd-button--secondary\"]");

    By EmployeTypeForHints = By.xpath("//*[@placeholder=\"Type for hints...\"]");

    By Create = By.xpath("//*[@type=\"submit\"]");
    By Submit = By.xpath("//*[@type=\"button\" and @class=\"oxd-button oxd-button--medium oxd-button--secondary orangehrm-sm-button\"]");
    By Back = By.xpath("//*[@class=\"oxd-button oxd-button--medium oxd-button--ghost orangehrm-sm-button\"]");

    By assertAlice = By.xpath("//*[contains(text(), 'Alice Duval')]");
